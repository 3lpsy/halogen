...
/// List the playlists a podcast auto-adds new episodes to. Stale links (the playlist was deleted) are filtered
/// out by intersecting with the live playlist ids, so the result only ever references existing playlists —
