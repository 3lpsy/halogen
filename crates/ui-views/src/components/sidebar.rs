...
mod tests {
    ...
    #[test]
    fn nav_item_has_correct_structure() {
        let item = crate::components::nav::model::NavItem {
            key: halogen_ui_config::NavKey::Builtin(halogen_ui_config::BuiltinNav::Queue),
            label: "Test".to_string(),
            route: Route::Queue {},
            admin_only: false,
        };
        assert_eq!(item.label, "Test");
        assert_eq!(item.route, Route::Queue {});
    }
}
