//! Admin-only "view config" page (`/settings/config`).
//!
//! Fetches the server's reconciled runtime config (`GET /api/v1/config`, secrets
//! already stripped server-side) and renders it read-only, grouped into labelled
//! sections with an "Other" catch-all at the bottom for ungroupable knobs.
...
use halogen_ui_icons::{ArrowPath, Pencil};
            ...
            div { class: "p-2 flex items-center justify-between gap-2",
                ...
                div { class: "flex items-center gap-1",
                    button {
                        ...
                        onclick: move |_| {
                            nav.push(Route::ConfigOverridesEdit {});
                        },
