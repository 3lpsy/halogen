// Bootstrap for the Halogen sync Web Worker (halogen-ui-worker): dx has no
// web-worker target (DioxusLabs/dioxus #3275), so this is our own wasm-bindgen
// --target no-modules build (justfile `_worker-build`); the main thread starts
// it via `new Worker('/worker.js')` (see `WebWorkerRuntime`).
