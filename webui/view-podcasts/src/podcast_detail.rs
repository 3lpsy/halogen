...
use halogen_webui_component_widgets::{ConfirmLinkModal, ExpandablePodcastDescription};
    ...
    rsx! {
        ...
        div { class: "flex flex-col h-full",
            ...
            if let Some(p) = podcast {
                div { class: "p-2 flex gap-4 border-b border-base-200 shrink-0 max-h-[50%] overflow-y-auto",
