...
outline_icon!(
    /// Heroicons — `face-frown` (outline). MIT (https://github.com/tailwindlabs/heroicons).
    /// Stroke-based (not filled); `stroke-width: 2` gives it a bolder line than the
    /// 1.5 default so it reads clearly as the "no artwork / 404" placeholder.
    FaceFrown,
    "0 0 24 24",
    "2",
