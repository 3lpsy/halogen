//! Shared confirmation shell, rendered only while the caller considers it open. The caller owns busy state and
//! confirm/cancel callbacks; see the crate README for an example.
