...
use halogen_webui_component_icons::{Pause, Play, XMark};
use halogen_webui_hooks::{use_config, use_now_playing, use_player_controller, use_podcasts};
use halogen_webui_player::PlaybackState;

/// Compact player metadata expands the full-screen view. `Signal<EpisodeState>` props compare by pointer, avoiding
/// ReadSignal's value-memoization dirtying; body reads still subscribe normally.
#[component]
